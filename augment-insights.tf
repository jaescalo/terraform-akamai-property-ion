data "akamai_property_rules_builder" "wingmanstrums-com_rule_augment_insights" {
  rules_v2023_10_30 {
    ...
    children = [
      data.akamai_property_rules_builder.wingmanstrums-com_rule_traffic_reporting.json,
      data.akamai_property_rules_builder.wingmanstrums-com_rule_m_pulse_rum.json,
      data.akamai_property_rules_builder.wingmanstrums-com_rule_geolocation.json,
      data.akamai_property_rules_builder.wingmanstrums-com_rule_log_delivery.json,
    ]
  }
}

data "akamai_property_rules_builder" "wingmanstrums-com_rule_traffic_reporting" {
  rules_v2023_10_30 {
...
data "akamai_property_rules_builder" "wingmanstrums-com_rule_m_pulse_rum" {
  rules_v2023_10_30 {
    name                  = "mPulse RUM"
...
data "akamai_property_rules_builder" "wingmanstrums-com_rule_geolocation" {
  rules_v2023_10_30 {
    name                  = "Geolocation"
...
data "akamai_property_rules_builder" "wingmanstrums-com_rule_log_delivery" {
  rules_v2023_10_30 {
    name                  = "Log delivery"
