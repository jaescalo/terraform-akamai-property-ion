...
data "akamai_property_rules_builder" "my-resource_rule_augment_insights" {
  rules_v2023_10_30 {
    ...
    children = [
      data.akamai_property_rules_builder.my-resource_rule_traffic_reporting.json,
      data.akamai_property_rules_builder.my-resource_rule_m_pulse_rum.json,
      data.akamai_property_rules_builder.my-resource_rule_geolocation.json,
      data.akamai_property_rules_builder.my-resource_rule_log_delivery.json,
    ]
  }
}

data "akamai_property_rules_builder" "my-resource_rule_accelerate_delivery" {
  rules_v2023_10_30 {
    ...
    criteria_must_satisfy = "all"
    children = [
      data.akamai_property_rules_builder.my-resource_rule_origin_connectivity.json,
      data.akamai_property_rules_builder.my-resource_rule_protocol_optimizations.json,
      data.akamai_property_rules_builder.my-resource_rule_prefetching.json,
      data.akamai_property_rules_builder.my-resource_rule_adaptive_acceleration.json,
    ]
  }
}

data "akamai_property_rules_builder" "my-resource_rule_offload_origin" {
  rules_v2023_10_30 {
    name                  = "Offload origin"
    ...
    children = [
      data.akamai_property_rules_builder.my-resource_rule_css_and_java_script.json,
      data.akamai_property_rules_builder.my-resource_rule_fonts.json,
      data.akamai_property_rules_builder.my-resource_rule_images.json,
      data.akamai_property_rules_builder.my-resource_rule_files.json,
      data.akamai_property_rules_builder.my-resource_rule_other_static_objects.json,
      data.akamai_property_rules_builder.my-resource_rule_html_pages.json,
      data.akamai_property_rules_builder.my-resource_rule_redirects.json,
      data.akamai_property_rules_builder.my-resource_rule_post_responses.json,
      data.akamai_property_rules_builder.my-resource_rule_graph_ql.json,
      data.akamai_property_rules_builder.my-resource_rule_uncacheable_objects.json,
    ]
  }
}

data "akamai_property_rules_builder" "my-resource_rule_strengthen_security" {
  rules_v2023_10_30 {
    ...
    criteria_must_satisfy = "all"
    children = [
      data.akamai_property_rules_builder.my-resource_rule_allowed_methods.json,
      data.akamai_property_rules_builder.my-resource_rule_obfuscate_debug_info.json,
      data.akamai_property_rules_builder.my-resource_rule_obfuscate_backend_info.json,
      data.akamai_property_rules_builder.my-resource_rule_hsts.json,
    ]
  }
}

data "akamai_property_rules_builder" "my-resource_rule_increase_availability" {
  rules_v2023_10_30 {
    ...
    criteria_must_satisfy = "all"
    children = [
      data.akamai_property_rules_builder.my-resource_rule_simulate_failover.json,
      data.akamai_property_rules_builder.my-resource_rule_site_failover.json,
      data.akamai_property_rules_builder.my-resource_rule_origin_health.json,
      data.akamai_property_rules_builder.my-resource_rule_script_management.json,
    ]
  }
}

data "akamai_property_rules_builder" "my-resource_rule_minimize_payload" {
  rules_v2023_10_30 {
    ...
    criteria_must_satisfy = "all"
    children = [
      data.akamai_property_rules_builder.my-resource_rule_compressible_objects.json,
    ]
  }
}

data "akamai_property_rules_builder" "my-resource_rule_traffic_reporting" {
  rules_v2023_10_30 {
...
data "akamai_property_rules_builder" "my-resource_rule_m_pulse_rum" {
  rules_v2023_10_30 {
    name                  = "mPulse RUM"
...
data "akamai_property_rules_builder" "my-resource_rule_geolocation" {
  rules_v2023_10_30 {
    name                  = "Geolocation"
...
data "akamai_property_rules_builder" "my-resource_rule_log_delivery" {
  rules_v2023_10_30 {
    name                  = "Log delivery"
...
data "akamai_property_rules_builder" "my-resource_rule_origin_connectivity" {
  rules_v2023_10_30 {
...
data "akamai_property_rules_builder" "my-resource_rule_protocol_optimizations" {
  rules_v2023_10_30 {
...
data "akamai_property_rules_builder" "my-resource_rule_prefetching" {
  rules_v2023_10_30 {
    name                  = "Prefetching"
    comments              = "Instruct edge servers to retrieve embedded resources before the browser requests them."
    criteria_must_satisfy = "all"
    children = [
      data.akamai_property_rules_builder.my-resource_rule_prefetching_objects.json,
      data.akamai_property_rules_builder.my-resource_rule_prefetchable_objects.json,
    ]
  }
}

data "akamai_property_rules_builder" "my-resource_rule_adaptive_acceleration" {
  rules_v2023_10_30 {
...
data "akamai_property_rules_builder" "my-resource_rule_prefetching_objects" {
  rules_v2023_10_30 {
    ...
    children = [
      data.akamai_property_rules_builder.my-resource_rule_bots.json,
    ]
  }
}

data "akamai_property_rules_builder" "my-resource_rule_prefetchable_objects" {
  rules_v2023_10_30 {
...
data "akamai_property_rules_builder" "my-resource_rule_bots" {
  rules_v2023_10_30 {
    name                  = "Bots"
...
data "akamai_property_rules_builder" "my-resource_rule_css_and_java_script" {
  rules_v2023_10_30 {
...
data "akamai_property_rules_builder" "my-resource_rule_fonts" {
  rules_v2023_10_30 {
    name                  = "Fonts"
...
data "akamai_property_rules_builder" "my-resource_rule_images" {
  rules_v2023_10_30 {
    name                  = "Images"
...
data "akamai_property_rules_builder" "my-resource_rule_files" {
  rules_v2023_10_30 {
    name                  = "Files"
...
data "akamai_property_rules_builder" "my-resource_rule_other_static_objects" {
  rules_v2023_10_30 {
...
data "akamai_property_rules_builder" "my-resource_rule_html_pages" {
  rules_v2023_10_30 {
    name                  = "HTML pages"
...
data "akamai_property_rules_builder" "my-resource_rule_redirects" {
  rules_v2023_10_30 {
    name                  = "Redirects"
...
data "akamai_property_rules_builder" "my-resource_rule_post_responses" {
  rules_v2023_10_30 {
    name                  = "POST responses"
...
data "akamai_property_rules_builder" "my-resource_rule_graph_ql" {
  rules_v2023_10_30 {
    name                  = "GraphQL"
...
data "akamai_property_rules_builder" "my-resource_rule_uncacheable_objects" {
  rules_v2023_10_30 {
...
data "akamai_property_rules_builder" "my-resource_rule_allowed_methods" {
  rules_v2023_10_30 {
    ...
    children = [
      data.akamai_property_rules_builder.my-resource_rule_post.json,
      data.akamai_property_rules_builder.my-resource_rule_options.json,
      data.akamai_property_rules_builder.my-resource_rule_put.json,
      data.akamai_property_rules_builder.my-resource_rule_delete.json,
      data.akamai_property_rules_builder.my-resource_rule_patch.json,
    ]
  }
}

data "akamai_property_rules_builder" "my-resource_rule_obfuscate_debug_info" {
  rules_v2023_10_30 {
...
data "akamai_property_rules_builder" "my-resource_rule_obfuscate_backend_info" {
  rules_v2023_10_30 {
...
data "akamai_property_rules_builder" "my-resource_rule_hsts" {
  rules_v2023_10_30 {
    name                  = "HSTS"
...
data "akamai_property_rules_builder" "my-resource_rule_post" {
  rules_v2023_10_30 {
    name                  = "POST"
...
data "akamai_property_rules_builder" "my-resource_rule_options" {
  rules_v2023_10_30 {
    name                  = "OPTIONS"
...
data "akamai_property_rules_builder" "my-resource_rule_put" {
  rules_v2023_10_30 {
    name                  = "PUT"
...
data "akamai_property_rules_builder" "my-resource_rule_delete" {
  rules_v2023_10_30 {
    name                  = "DELETE"
...
data "akamai_property_rules_builder" "my-resource_rule_patch" {
  rules_v2023_10_30 {
    name                  = "PATCH"
...
data "akamai_property_rules_builder" "my-resource_rule_simulate_failover" {
  rules_v2023_10_30 {
...
data "akamai_property_rules_builder" "my-resource_rule_site_failover" {
  rules_v2023_10_30 {
    name                  = "Site failover"
...
data "akamai_property_rules_builder" "my-resource_rule_origin_health" {
  rules_v2023_10_30 {
    name                  = "Origin health"
...
data "akamai_property_rules_builder" "my-resource_rule_script_management" {
  rules_v2023_10_30 {
...
data "akamai_property_rules_builder" "my-resource_rule_compressible_objects" {
  rules_v2023_10_30 {
