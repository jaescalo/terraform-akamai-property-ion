data "akamai_property_rules_builder" "wingmanstrums-com_rule_offload_origin" {
  rules_v2023_10_30 {
    name                  = "Offload origin"
    ...
    children = [
      data.akamai_property_rules_builder.wingmanstrums-com_rule_css_and_java_script.json,
      data.akamai_property_rules_builder.wingmanstrums-com_rule_fonts.json,
      data.akamai_property_rules_builder.wingmanstrums-com_rule_images.json,
      data.akamai_property_rules_builder.wingmanstrums-com_rule_files.json,
      data.akamai_property_rules_builder.wingmanstrums-com_rule_other_static_objects.json,
      data.akamai_property_rules_builder.wingmanstrums-com_rule_html_pages.json,
      data.akamai_property_rules_builder.wingmanstrums-com_rule_redirects.json,
      data.akamai_property_rules_builder.wingmanstrums-com_rule_post_responses.json,
      data.akamai_property_rules_builder.wingmanstrums-com_rule_graph_ql.json,
      data.akamai_property_rules_builder.wingmanstrums-com_rule_uncacheable_objects.json,
    ]
  }
}

data "akamai_property_rules_builder" "wingmanstrums-com_rule_css_and_java_script" {
  rules_v2023_10_30 {
...
data "akamai_property_rules_builder" "wingmanstrums-com_rule_fonts" {
  rules_v2023_10_30 {
    name                  = "Fonts"
...
data "akamai_property_rules_builder" "wingmanstrums-com_rule_images" {
  rules_v2023_10_30 {
    name                  = "Images"
...
data "akamai_property_rules_builder" "wingmanstrums-com_rule_files" {
  rules_v2023_10_30 {
    name                  = "Files"
...
data "akamai_property_rules_builder" "wingmanstrums-com_rule_other_static_objects" {
  rules_v2023_10_30 {
...
data "akamai_property_rules_builder" "wingmanstrums-com_rule_html_pages" {
  rules_v2023_10_30 {
    name                  = "HTML pages"
...
data "akamai_property_rules_builder" "wingmanstrums-com_rule_redirects" {
  rules_v2023_10_30 {
    name                  = "Redirects"
...
data "akamai_property_rules_builder" "wingmanstrums-com_rule_post_responses" {
  rules_v2023_10_30 {
    name                  = "POST responses"
...
data "akamai_property_rules_builder" "wingmanstrums-com_rule_graph_ql" {
  rules_v2023_10_30 {
    name                  = "GraphQL"
...
data "akamai_property_rules_builder" "wingmanstrums-com_rule_uncacheable_objects" {
  rules_v2023_10_30 {
