data "akamai_property_rules_builder" "wingmanstrums-com_rule_minimize_payload" {
  rules_v2023_10_30 {
    ...
    children = [
      data.akamai_property_rules_builder.wingmanstrums-com_rule_compressible_objects.json,
    ]
  }
}

data "akamai_property_rules_builder" "wingmanstrums-com_rule_compressible_objects" {
  rules_v2023_10_30 {
