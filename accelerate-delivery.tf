data "akamai_property_rules_builder" "wingmanstrums-com_rule_accelerate_delivery" {
  rules_v2023_10_30 {
    ...
    children = [
      data.akamai_property_rules_builder.wingmanstrums-com_rule_origin_connectivity.json,
      data.akamai_property_rules_builder.wingmanstrums-com_rule_protocol_optimizations.json,
      data.akamai_property_rules_builder.wingmanstrums-com_rule_prefetching.json,
      data.akamai_property_rules_builder.wingmanstrums-com_rule_adaptive_acceleration.json,
    ]
  }
}

data "akamai_property_rules_builder" "wingmanstrums-com_rule_origin_connectivity" {
  rules_v2023_10_30 {
...
data "akamai_property_rules_builder" "wingmanstrums-com_rule_protocol_optimizations" {
  rules_v2023_10_30 {
...
data "akamai_property_rules_builder" "wingmanstrums-com_rule_prefetching" {
  rules_v2023_10_30 {
    name                  = "Prefetching"
    comments              = "Instruct edge servers to retrieve embedded resources before the browser requests them."
    criteria_must_satisfy = "all"
    children = [
      data.akamai_property_rules_builder.wingmanstrums-com_rule_prefetching_objects.json,
      data.akamai_property_rules_builder.wingmanstrums-com_rule_prefetchable_objects.json,
    ]
  }
}

data "akamai_property_rules_builder" "wingmanstrums-com_rule_adaptive_acceleration" {
  rules_v2023_10_30 {
...
data "akamai_property_rules_builder" "wingmanstrums-com_rule_prefetching_objects" {
  rules_v2023_10_30 {
    ...
    children = [
      data.akamai_property_rules_builder.wingmanstrums-com_rule_bots.json,
    ]
  }
}

data "akamai_property_rules_builder" "wingmanstrums-com_rule_prefetchable_objects" {
  rules_v2023_10_30 {
...
data "akamai_property_rules_builder" "wingmanstrums-com_rule_bots" {
  rules_v2023_10_30 {
    name                  = "Bots"
